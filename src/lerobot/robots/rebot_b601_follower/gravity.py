"""B601-DM gravity feedforward used by the safe-home trajectory."""
...
class B601GravityFeedforward:
    ...
    def __init__(self) -> None:
        try:
            ...
            raise RuntimeError(
                "B601-DM MIT control could not load Pinocchio. The installed "
                "Pinocchio/C++ libraries are missing or ABI-incompatible. Use a "
                "coherent conda-forge Pinocchio installation (matching the working "
                "lerobot_062 environment), then retry."
            ) from error
